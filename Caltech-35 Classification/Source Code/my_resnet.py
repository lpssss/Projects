# The code here is modified from pytorch implementation on resnet
# https://github.com/pytorch/vision/blob/master/torchvision/models/resnet.py#L87
...
class MyResNet(nn.Module):
    ...
    def __init__(
            self,
            block: Type[Union[MyBasicBlock, MyBottleneck]],
            layers: List[int],
            num_classes: int = 35,
    ...
    def _make_layer(self, block: Type[Union[MyBasicBlock, MyBottleneck]], planes: int, blocks: int,
